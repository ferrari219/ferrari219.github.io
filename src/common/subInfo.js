	...
	return (
		<div className={`gridContainer ${style.subInfo}`}>
			...
			<div className="grid10">
				{checked === true ? <TextTemplate title="I am" line1={subInfo.iam} /> : <TextTemplate title="I am" line1={subInfo.iamEn} />}
				<TextTemplate title="Experience" griddl2={subInfo.exp} checked={checked} />
			</div>
		</div>
	);
};
